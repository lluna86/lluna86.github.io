...
<div class="flex flex-wrap">
    <div class="bg-[url('/assets/images/servicios.jpg')] w-full h-80 bg-cover bg-bottom flex justify-center items-center">
        <h1 class="text-gray-800 font-quicksand text-3xl sm:text-5xl font-semibold text-center">Servicios psicológicos</h1>
    </div>
</div>
...
<div id="terapia_individual" class="px-4 py-6 sm:px-8 md:py-12 lg:px-24 lg:py-16 xl:px-48 2xl:px-64 bg-gray-100">
    ...
    <div class="flex flex-wrap items-center">
        <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
            <img class="object-cover h-32 w-full rounded-xl" src="/assets/images/nenufar.jpg">
        </div>
...
<div id="terapia_de_pareja" class="px-4 py-6 sm:px-8 md:py-12 lg:px-24 lg:py-16 xl:px-48 2xl:px-64 bg-planta-light">
    ...
    <div class="flex flex-wrap items-center">
        <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
            <img class="object-cover h-32 w-full rounded-xl" src="/assets/images/jarros.jpg">
        </div>
...
<div class="px-4 sm:px-8 lg:px-24 xl:px-48 2xl:px-64 bg-planta-light py-6 sm:py-12">
    ...
    <div class="flex flex-wrap items-center">
        <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
            <img class="object-cover h-32 w-full rounded-xl" src="/assets/images/flores-azules.jpg">
        </div>
        <div class="w-full sm:w-3/4 px-4 text-justify">
...
<div class="px-4 py-6 sm:px-8 md:py-12 lg:px-24 lg:py-16 xl:px-48 2xl:px-64 bg-gray-100">
    ...
    <div class="flex flex-wrap items-center">
        <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
            <img class="object-cover h-32 w-full rounded-xl" src="/assets/images/planta-interior.jpg">
        </div>
        <div class="w-full sm:w-3/4 px-4 text-justify">
...
<div class="px-4 sm:px-8 lg:px-24 xl:px-48 2xl:px-64 bg-planta-light py-6 sm:py-12">
    ...
    <div class="flex flex-wrap items-center">
        <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
            <img class="object-cover h-32 w-full rounded-xl" src="/assets/images/plantas.jpg">
        </div>
        <div class="w-full sm:w-3/4 px-4 text-justify">
