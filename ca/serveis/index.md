...
<div class="flex flex-wrap">
    <div class="bg-[url('/assets/images/servicios.webp')] w-full h-80 bg-cover bg-bottom flex justify-center items-center">
        <h1 class="text-gray-800 font-quicksand text-3xl sm:text-5xl font-semibold text-center">Serveis psicològics</h1>
    </div>
</div>

<div id="terapia_individual" class="px-4 py-6 sm:px-8 md:py-12 lg:px-24 lg:py-16 xl:px-48 2xl:px-64 bg-gray-100">
    <h2 class="text-3xl text-center">Teràpia individual</h2>
    ...
    <div class="flex flex-wrap justify-center mt-6">
        <a href="terapia-individual"><button class="mt-4 px-6 py-2 text-xl text-white bg-planta hover:bg-planta-fosc rounded">Més informació</button></a>
    </div>
</div>

<div id="terapia_de_pareja" class="px-4 py-6 sm:px-8 md:py-12 lg:px-24 lg:py-16 xl:px-48 2xl:px-64 bg-planta-light">
    <h2 class="text-3xl text-center">Teràpia de parella</h2>
    ...
    <div class="flex flex-wrap justify-center mt-6">
        <a href="terapia-de-parella"><button class="mt-4 px-6 py-2 text-xl text-white bg-planta hover:bg-planta-fosc rounded">Més informació</button></a>
    </div>
</div>
...
<div class="px-4 py-6 sm:px-8 md:py-12 lg:px-24 lg:py-16 xl:px-48 2xl:px-64 bg-gray-100">
    ...
    <div class="flex flex-wrap justify-center mt-6">
        <a href="terapia-online/"><button class="mt-4 px-6 py-2 text-xl text-white bg-planta hover:bg-planta-fosc rounded">Més informació</button></a>
    </div>
</div>

<div class="px-4 sm:px-8 lg:px-24 xl:px-48 2xl:px-64 bg-planta-light py-6 sm:py-12">
    <h2 class="text-3xl text-center">Sessions de suport a la criança</h2>
    ...
    <div class="flex flex-wrap justify-center mt-6">
        <a href="suport-a-la-crianca"><button class="mt-4 px-6 py-2 text-xl text-white bg-planta hover:bg-planta-fosc rounded">Més informació</button></a>
    </div>
</div>
...
<div class="px-4 sm:px-8 lg:px-24 xl:px-48 2xl:px-64 bg-planta-light py-6 sm:py-12">
    <h2 class="text-3xl text-center">Assessoraments i tallers</h2>
    <hr class="w-16 h-1 mx-auto bg-planta-clar border-0 rounded mt-4 sm:mt-8 mb-2 sm:mb-4">
    <div class="flex flex-wrap items-center">
        <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
    ...
    <div class="flex flex-wrap justify-center mt-6">
        <a href="assessorament-i-tallers"><button class="mt-4 px-6 py-2 text-xl text-white bg-planta hover:bg-planta-fosc rounded">Més informació</button></a>
    </div>
</div>
