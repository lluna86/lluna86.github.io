...
permalink: /ca/legal/
title: "Avís legal"
metadescription: "Avís legal, condicions d'ús i política de privacitat de Berta Sanfeliu Psicologia."
---
<div class="px-4 sm:px-8 md:py-12 lg:px-24 lg:py-12 xl:px-48 2xl:px-64">
	<h1 class="pb-8">Text legal</h1>
	<h2 class="pb-4 text-xl">Termes i condicions</h2>
	<div><b>Responsable:</b> Berta Sanfeliu Salvà</div>
	<div><b>Finalitat:</b> Atendre sol·licitud</div>
	<div><b>Legitimació:</b> Consentiment</div>
	<div><b>Destinataris:</b> No es cediran dades a tercers, excepte obligació legal.</div>
