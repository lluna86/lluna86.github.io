---
layout: en/default
permalink: /en/legal-text/
---
<div class="px-4 sm:px-8 md:py-12 lg:px-24 lg:py-12 xl:px-48 2xl:px-64">
	<h1 class="pb-8">Legal Text</h1>
	<h2 class="pb-4 text-xl">Terms and Conditions</h2>
	<div><b>Responsible party:</b> Berta Sanfeliu Salvà</div>
	<div><b>Purpose:</b> To address requests</div>
	<div><b>Legitimacy:</b> Consent</div>
	<div><b>Recipients:</b> Data will not be transferred to third parties, except legal obligation.</div>
